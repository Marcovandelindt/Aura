    ...
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 500;">Backstory</label>
                    <textarea name="backstory" class="form-control" rows="8" placeholder="Paste the full narrative profile generated by AI here — backstory, biography, hobbies, speech patterns, everything...">{{ old('backstory', $conversation->backstory ?? '') }}</textarea>
                    <p style="font-size: 0.75rem; color: #888; margin-top: 0.25rem;">Paste the rich narrative output from the character profile generator. This is included in every email export for extra context.</p>
                    @error('backstory')<p style="color: #ef4444; font-size: 0.8rem; margin-top: 0.25rem;">{{ $message }}</p>@enderror
                </div>
            </div>
        </div>
    </div>
