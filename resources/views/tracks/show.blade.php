        ...
        <div class="card-body">
            <div style="display: flex; align-items: flex-start; gap: 2rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <p style="margin: 0 0 1rem 0; font-size: 1.25rem; color: #666;">by
                        @foreach($track->artist_names as $i => $artistName)
                            <a href="{{ route('artists.show', ['artist' => urlencode($artistName)]) }}" style="color: #666;">{{ $artistName }}</a>@if($i < count($track->artist_names) - 1), @endif
                        @endforeach
                    </p>
